...
class TestPostsIntegration:
    async def test_create_post(
        ...
        new_post = {"title": "CREATE Test Post", "body": "Test content"}
    ...
    async def test_get_post_by_id(
        ...
        new_post = {"title": "FIND Test Post", "body": "Test content"}
    ...
    async def test_update_post(
        ...
        new_post = {"title": "UPDATE Test Post", "body": "Test content"}

        new_post_body = {"body": "New post body"}
        ...
        response = await test_client.put(
            f"/posts/update/{post_id}/", json=new_post_body
        )
        assert response.status_code == status.HTTP_200_OK
    ...
    async def test_delete_post(
        ...
        new_post = {"title": "DELETE Test Post", "body": "Test content"}
